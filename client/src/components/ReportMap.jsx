              ...
              issues
                ...
                .map((issue) => (
                  <Marker
                    ...
                    icon={issue.source === "IoT Auto Detection" ? defaultIcon : defaultIcon}
                  >
                    <Popup>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
            {flaggedIssues.map((issue) => (
              <div
                key={issue._id}
                onClick={() => { }}
                className={`bg-white rounded-xl shadow border p-4 hover:shadow-md transition-allcursor-pointer hover:ring-2 hover:ring-indigo-100 ${issue.source === "IoT Auto Detection" ? "border-blue-200 bg-blue-50/30" : "border-red-100"
                  }`}
              >
